...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'qhj&6*!scrjh91m&_22bt5t)abtv0&uo!4t2sq10yvxzqu&(ou')
...
LANGUAGE_CODE = 'en-us' # Language in which original texts are written 
...
STATIC_PATH = os.path.join(BASE_DIR, 'static', 'media')
